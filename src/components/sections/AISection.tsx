  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20">
        <div className="absolute top-1/2 left-1/4 w-40 h-40 bg-gradient-to-br from-teal-300/40 to-transparent rounded-full blur-3xl opacity-80 animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-32 h-32 bg-gradient-to-br from-slate-300/40 to-transparent rounded-full blur-2xl opacity-80 animate-pulse" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/4 right-1/3 w-24 h-24 bg-gradient-to-br from-teal-400/30 to-transparent rounded-full blur-xl animate-pulse" style={{animationDelay: '1s'}}></div>
      </div>
