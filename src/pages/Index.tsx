...
import { CheckCircle, Calendar, Users, Home as HomeIcon } from "lucide-react";
...
const services = [
  ...
  {
    icon: <Users size={22} className="text-propcloud-600" />,
  ...
  {
    icon: <HomeIcon size={22} className="text-propcloud-600" />,
    ...
    <div className="min-h-screen bg-white flex flex-col font-sans overflow-x-hidden relative">
      ...
      <main>
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold mb-5 max-w-4xl mx-auto leading-tight bg-gradient-to-r from-propcloud-600 to-propcloud-400 bg-clip-text text-transparent animate-fade-up">
          ...
          <a
            href="#contact"
            className="inline-block rounded-lg bg-gradient-to-r from-propcloud-600 to-propcloud-400 text-white font-bold px-9 py-4 text-lg shadow-soft hover:brightness-110 hover:scale-105 transition duration-150 animate-fade-up"
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-3 bg-gradient-to-r from-propcloud-600 to-propcloud-400 bg-clip-text text-transparent animate-fade-up">
        ...
        >
          <h2 className="font-bold text-3xl md:text-4xl mb-10 bg-gradient-to-r from-propcloud-600 to-propcloud-400 bg-clip-text text-transparent text-center animate-fade-up">
            How It Works
          </h2>
          <div className="max-w-3xl mx-auto grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-r from-propcloud-600 to-propcloud-400 text-white font-bold shadow-soft text-2xl mb-3">
                  {idx + 1}
                </div>
        ...
        >
          <div className="max-w-3xl mx-auto flex flex-col items-center text-center gap-6">
            <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-propcloud-600 to-propcloud-400 bg-clip-text text-transparent animate-fade-up">
            ...
            <a
              href="/about"
              className="inline-block bg-gradient-to-r from-propcloud-600 to-propcloud-400 text-white font-bold rounded-lg px-8 py-3 text-lg shadow-soft hover:brightness-110 hover:scale-105 transition-all animate-fade-up"
            >
              Learn More
            </a>
          </div>
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-propcloud-600 to-propcloud-400 bg-clip-text text-transparent animate-fade-up">
            Get Started Today
          </h2>
          <p className="text-lg text-propcloud-900 mb-8 animate-fade-up">
            We'd love to help you grow. Schedule a free call or reach us directly:
          </p>
          <a
            href="https://calendly.com/propcloud/consultation"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block bg-gradient-to-r from-propcloud-600 to-propcloud-400 text-white font-bold rounded-lg px-8 py-4 text-lg shadow-soft hover:brightness-110 hover:scale-105 transition mb-6 animate-fade-up"
          >
            Book Free Consultation
          </a>
          <div className="text-base text-propcloud-600 mt-2 animate-fade-up">contact@propcloud.io</div>
        </section>
      </main>
      <Footer />
    </div>
